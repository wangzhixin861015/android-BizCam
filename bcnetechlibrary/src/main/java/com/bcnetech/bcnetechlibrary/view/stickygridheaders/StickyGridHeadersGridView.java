...
import com.bcnetech.bcnetechlibrary.view.stickygridheaders.StickyGridHeadersBaseAdapterWrapper.HeaderFillerView;
...
public class StickyGridHeadersGridView extends GridView implements OnScrollListener,
    ...
    public void addHeaderLayout(View headerLayout){
    ...
    public void addFooterLayout(View footerLayout){
