...
public class PickerViewVSecal extends View
{
    /**
     * 传进来的·高度值，决定了绘制的字体大小，
     */
     ...
     */
    public static final float MARGIN_ALPHA = 7.5f;
    /**
     * 自动回滚到中间的速度
     */
    ...
    private PickerViewVSecal.onSelectListener mSelectListener;
    private Timer timer;
    private PickerViewVSecal.MyTimerTask mTask;
    ...
    public PickerViewVSecal(Context context)
    {
        super(context);
        init();
    }

    public PickerViewVSecal(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }
     ...
     * @param listener
     */
    public void setOnSelectListener(PickerViewVSecal.onSelectListener listener)
    {
    ...
    private void doUp(MotionEvent event)
    {
        ...
        mTask = new PickerViewVSecal.MyTimerTask(updateHandler);
