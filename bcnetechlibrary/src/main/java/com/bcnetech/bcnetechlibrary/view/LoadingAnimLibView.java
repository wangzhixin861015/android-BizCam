...
public class LoadingAnimLibView extends View {
    ...
    public LoadingAnimLibView(Context context) {
        super(context);
        getSize1();
    }

    public LoadingAnimLibView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        getSize1();

    }

    public LoadingAnimLibView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void getSize1() {
        ...
        vto.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                if (LENGTH == 0) {
                    int height = LoadingAnimLibView.this.getMeasuredHeight();
                    int width = LoadingAnimLibView.this.getMeasuredWidth();
                    LENGTH = width;
                    initDraw();
                    initValueAnim();
                }
    ...
    private void initValueAnim() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                LoadingAnimLibView.this.invalidate();
            }
        });
