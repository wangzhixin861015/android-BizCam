 ...
 * Date: 2016/1/14
 */
public class IndexableRecyclerView2 extends RelativeLayout {
    ...
    public IndexableRecyclerView2(Context context) {
        this(context, null);
    }

    public IndexableRecyclerView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IndexableRecyclerView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initViews(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.recyclerview_indexable2, this);
