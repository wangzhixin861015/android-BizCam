...
public class SectionedRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SectionedRecyclerAdapter(Context context, int sectionResourceId, int textResourceId, RecyclerView.Adapter baseAdapter) {
        ...
        if(mKeyPositionMap!=null) mKeyPositionMap.clear();
        this.context = context;
        mSections = new SparseArray<Section>();
        mKeyPositionMap = new SparseArray<>();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder sectionViewHolder, int position) {
        if (isSectionHeaderPosition(position)) {
            ...
            ((SectionViewHolder) sectionViewHolder).title.setTextColor(context.getResources().getColor(R.color.translucent));
        } else {
    ...
    public int getItemCount() {
        if(mBaseAdapter==null||mBaseAdapter.getItemCount()==0){
            mSections.clear();
