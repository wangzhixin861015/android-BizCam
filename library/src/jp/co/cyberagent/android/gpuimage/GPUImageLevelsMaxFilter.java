 ...
 */
public class GPUImageLevelsMaxFilter extends GPUImageFilter{

    private static final String LOGTAG = GPUImageLevelsMaxFilter.class.getSimpleName();
    ...
    public GPUImageLevelsMaxFilter() {
        this(new float[] {0.0f,0.0f,0.0f}, new float[] {1.0f, 1.0f, 1.0f }, new float[] {1.0f, 1.0f ,1.0f}, new float[] {0.0f, 0.0f, 0.0f}, new float[] {1.0f,1.0f,1.0f});
    }

    private GPUImageLevelsMaxFilter(final float[] min, final float[] mid, final float[] max, final float[] minOUt, final float[] maxOut) {
