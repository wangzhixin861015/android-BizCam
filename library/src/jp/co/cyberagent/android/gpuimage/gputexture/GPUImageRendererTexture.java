...
@TargetApi(11)
public class GPUImageRendererTexture implements GLTextureView.Renderer, PreviewCallback {
    ...
    private GPUImageTexture.ScaleType mScaleType = GPUImageTexture.ScaleType.CENTER_CROP;
    ...
    public GPUImageRendererTexture(final GPUImageFilter filter) {
        mFilter = filter;
    ...
    public void onDrawFrame(final GL10 gl) {
        ...
        synchronized (GPUImageRendererTexture.this) {
    ...
    private void adjustImageScaling() {
        ...
        if (mScaleType == GPUImageTexture.ScaleType.CENTER_CROP) {
...
//     */
//    public void setVideoEncoder(final GLTextureView mGLTextureView, final MediaVideoEncoderRunable mediaVideoEncoderRunable) {
//        mGLTextureView.queueEvent(new Runnable() {
//            @Override
//            public void run() {
//                synchronized (this) {
//                    if (mediaVideoEncoderRunable != null) {
//                        mediaVideoEncoderRunable.setEglContext(EGL14.eglGetCurrentContext(), mGLTextureView, mGLTextureId);
