...
public class GPUImageViewTexture extends FrameLayout {

    private GLTextureView mGLTextureView;
    private GPUImageTexture mGPUImage;
    private GPUImageFilter mFilter;
    public Size mForceSize = null;
    private float mRatio = 0.0f;
    private int orginWidth,orginHeight;


    public GPUImageViewTexture(Context context) {
        super(context);
        init(context, null);
    }

    public GPUImageViewTexture(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mGLTextureView.setAlpha(0.98f);

        //设置gpuimage背景为透明
       /* mGLSurfaceView.setZOrderOnTop(true);
        mGLSurfaceView.getHolder().setFormat(PixelFormat.TRANSLUCENT);*/
        addView(mGLTextureView);
        mGPUImage = new GPUImageTexture(getContext());
        mGPUImage.setGLSurfaceView(mGLTextureView);
     ...
     */
    public GPUImageTexture getGPUImage() {
            return mGPUImage;
    }
    ...
    public void setRect(Rect rect) {
        mGPUImage.setRect(rect);

    }
    public float[] getCube(){
        return mGPUImage.getCube();
    }
    public void setCube(float[] cube){
        mGPUImage.setCube(cube);
    }
    /**
     ...
     */
    public void setScaleType(GPUImageTexture.ScaleType scaleType) {
    ...
    public void setImage(final Bitmap bitmap) {
        ...
        if (bitmap!=null){
            orginWidth = bitmap.getWidth();
            orginHeight = bitmap.getHeight();
        }
    }

    public void setPartImage(final Bitmap bitmap) {
        mGPUImage.setPartImage(bitmap);
    }

    public void setPartImage2(final Bitmap bitmap) {
        mGPUImage.setPartImage2(bitmap);
    }
