 ...
 * tint:
 */
public class GPUImageWhiteBalanceTintFilter extends GPUImageFilter {
    ...
    public GPUImageWhiteBalanceTintFilter() {
        this(5000.0f, 0.0f);
    }

    public GPUImageWhiteBalanceTintFilter(final float temperature, final float tint) {
