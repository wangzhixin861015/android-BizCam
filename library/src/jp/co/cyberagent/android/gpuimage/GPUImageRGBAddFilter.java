 ...
 * blue:
 */
public class GPUImageRGBAddFilter extends GPUImageFilter {
    ...
    public GPUImageRGBAddFilter() {
        this(1.0f, 1.0f, 1.0f);
    }

    public GPUImageRGBAddFilter(final float red, final float green, final float blue) {
