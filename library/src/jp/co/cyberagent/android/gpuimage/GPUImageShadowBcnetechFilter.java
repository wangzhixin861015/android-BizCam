...
public class GPUImageShadowBcnetechFilter extends GPUImageFilter {
    public static final String HIGHLIGHT_SHADOW_FRAGMENT_SHADER = "" +
            ...
            "lowp vec4 dest;\n" +
            //     lowp float redvalue = 100.0;
            //     lowp float greenvalue = 100.0;
            //     lowp float bluevalue = 100.0;
            //     //float highlights = ;
            //     lowp float num6 = 20.0;//token.High_T tonal Range
            //     //float shadows = shadowsValue;
            //     lowp float num8 = 100.0;//token.Shadows_T tonal Range
            //     lowp float slevels = 75.0;//token.Slevels Local Contrast Intensity
            //     lowp float hstaturation = 0.0;//token.Hsaturation
            //     lowp float ssaturation = 90.0;//token.Sstaturation
            //     lowp float deepshadow = 50.0;//token.Deepshadow Compression
            //bool flag = YES;
    ...
    public GPUImageShadowBcnetechFilter(final float shadows, final float highlights) {
