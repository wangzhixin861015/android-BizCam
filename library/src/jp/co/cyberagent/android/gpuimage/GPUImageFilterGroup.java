    ...
    public void onDraw(final int textureId,final int[] textureIds, final FloatBuffer cubeBuffer,
        ...
        if (mMergedFilters != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (i == 0) {
                    filter.setMatrixM(mVpMatrix);
                    filter.onDraw(previousTexture,textureIds, mGLCubeBuffer, textureBuffer);
                } else if (i == size - 1) {
                    filter.setMatrixM(mVpMatrix);
                    filter.onDraw(previousTexture,textureIds, cubeBuffer, (size % 2 == 0) ? mGLTextureFlipBuffer : mGLTextureBuffer);
                } else {
                    filter.setMatrixM(mVpMatrix);
                    filter.onDraw(previousTexture,textureIds, mGLCubeBuffer, mGLTextureBuffer);
                }
