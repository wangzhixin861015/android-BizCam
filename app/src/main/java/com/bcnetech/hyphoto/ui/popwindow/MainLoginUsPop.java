...
public class MainLoginUsPop extends BasePopWindow {
    ...
    private MLoginNewUsView mLoginNewView;
    private boolean isClicked = false;


    public MainLoginUsPop(Activity activity) {
        super(activity);
    ...
    private void initView() {
        ...
        View view = inflater.inflate(R.layout.main_login_us_pop, null);
        ...
        mLoginNewView = (MLoginNewUsView) view.findViewById(R.id.mLoginNewView);
        setContentView(view);
    }
    ...
    public void setMLoginInter(MLoginNewUsView.MLoginInter mLoginInter) {
    ...
    public void translateAnim(int height) {
