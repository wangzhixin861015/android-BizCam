 ...
 */
public class WMFlowLayout extends ViewGroup {
    ...
    public interface FlowLayoutListener {
        void onselect(WaterMarkData drawable);

        void onLongClick(WaterMarkData drawable);
    }
    ...
    public void getChild() {
        ...
        for (int i = 0; i < count; i++) {
            final WaterMarkBottomView child = (WaterMarkBottomView) getChildAt(count - i - 1);
            if (child.getCurrentWMD() != null) {
                if (child.getCurrentWMD().getWatermarkurl() == null) {
            ...
            child.setWaterMarkBottomListener(new WaterMarkBottomView.WaterMarkBottomListener() {
                @Override
                public void onselect(WaterMarkData drawable) {
                    listener.onselect(drawable);
                    if (drawable != null) {
                        resetSelect(drawable);
                    }
                }

                @Override
                public void onLongClick(WaterMarkData drawable) {
                    listener.onLongClick(drawable);
                }
            });
        }
    }
    ...
    public WMFlowLayout(Context context) {
        this(context, null);
    }

    public WMFlowLayout(Context context, AttributeSet attrs) {
     ...
     */
    public WMFlowLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void deleteAllView() {
        WMFlowLayout.this.removeAllViews();
    }
}