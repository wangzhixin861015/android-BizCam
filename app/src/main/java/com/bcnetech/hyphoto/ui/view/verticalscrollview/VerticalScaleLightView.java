...
public class VerticalScaleLightView extends BaseRelativeLayout {
    ...
    public VerticalScaleLightView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VerticalScaleLightView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initView() {
        ...
        vScaleScrollView = (VerticalScaleScrollView) findViewById(R.id.verticalScaleLight);
