package com.bcnetech.hyphoto.ui.view.clickanimview;
...
public class BamImageView extends AppCompatImageView {
	...
	public interface TouchInter{
		void onClick();
	}

	public void setOnTouchInterface(TouchInter touchInterface){
		this.touchInter = touchInterface;
		LogUtil.d("asdasda");
	}
}
