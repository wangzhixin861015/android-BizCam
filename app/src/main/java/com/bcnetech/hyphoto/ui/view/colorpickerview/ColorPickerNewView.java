 ...
 */
public class ColorPickerNewView extends View {
     ...
     */
    private float HUE_PANEL_WIDTH = 24f;
    /**
    ...
    private int mSliderTrackerColor = 0xffffffff;
    ...
    public ColorPickerNewView(Context context) {
        this(context, null);
    }

    public ColorPickerNewView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorPickerNewView(Context context, AttributeSet attrs, int defStyle) {
...
//        drawAlphaPanel(canvas);
    ...
    private void drawHuePanel(Canvas canvas) {
        ...
        if (mHueShader == null) {
            mHueShader = new LinearGradient(rect.left, rect.top, rect.right, rect.bottom, buildHueColorArray(), null, TileMode.CLAMP);
        ...
        canvas.drawCircle((rect.left+rect.width()/2),p.y ,rect.width()/2, mHueTrackerPaint);
    }
    ...
    private void setUpHueRect() {
        ...
        float left = mSatValRect.right + PANEL_SPACING + BORDER_WIDTH_PX;
        float top = dRect.top + BORDER_WIDTH_PX;
        float right = left+ HUE_PANEL_WIDTH;
        float bottom = mSatValRect.bottom;
