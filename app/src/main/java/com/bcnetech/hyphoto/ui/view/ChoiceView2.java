...
public class ChoiceView2 extends BaseRelativeLayout {
    ...
    public ChoiceView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ChoiceView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public ChoiceView2 setCencelListener(OnClickListener listenr){
        findViewById(R.id.cencel).setOnClickListener(listenr);
        return this;
    }

    public ChoiceView2 setOkListener(OnClickListener listener){
        findViewById(R.id.ok).setOnClickListener(listener);
        return this;
    }

    public ChoiceView2 setCencelType2Listenr(OnClickListener listenr){
        findViewById(R.id.cencel_type2).setOnClickListener(listenr);
        return this;
    }

    public ChoiceView2 setOkType2Listenr(OnClickListener listenr){
        findViewById(R.id.ok_type2).setOnClickListener(listenr);
        return this;
    }
    public ChoiceView2 setOkType2Text(String text){
        ((TextView)findViewById(R.id.ok_type2)).setText(text);
        return this;
    }
    public ChoiceView2 setCencelType2Text(String text){
