package com.bcnetech.hyphoto.ui.view.viewPagerIndicator.view.indicator;

import android.view.View;
import android.view.ViewGroup;

import com.bcnetech.hyphoto.ui.view.viewPagerIndicator.view.indicator.slidebar.ScrollBar;
...
public interface Indicator {
    ...
    public static interface OnItemSelectedListener {
        /**
         * 注意 preItem 可能为 -1。表示之前没有选中过,
         * 每次adapter.notifyDataSetChanged也会将preItem设置为-1；
         *
