 ...
 */
public class PresetHorizontalListAdapter extends RecyclerView.Adapter<PresetHorizontalListAdapter.ViewHolder> {
    ...
    public PresetHorizontalListAdapter(Context context, List<PresetItem> presets) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new PresetHorizontalListAdapter.ViewHolder(inflater.inflate(R.layout.preset_horizonta_list_item,null));
    }
