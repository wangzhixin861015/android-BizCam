...
public class UploadIntoNativePop extends BasePopWindow {
    private TextView take_photo;
    private TextView system_ablum;
    private TextView intonative;
    ...
    public UploadIntoNativePop(Activity activity) {
        super(activity);
    ...
    private void initView(Activity activity) {
        ...
        View view = inflater.inflate(R.layout.upload_intonative_view_layout, null);
        ...
        intonative = (TextView) view.findViewById(R.id.intonative);
        setContentView(view);
    }
    ...
    private void onViewClick() {
        ...
        intonative.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                headimgPopListener.onIntonative();
            }
        });
    }
