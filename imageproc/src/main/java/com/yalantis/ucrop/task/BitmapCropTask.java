...
import com.yalantis.ucrop.util.UcropFileUtils;
...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    private boolean crop(float resizeScale) throws IOException {
         mCurrentScale=(float)(Math.round(mCurrentScale*10000))/10000;
        ...
        if (shouldCrop) {
            ...
            UcropFileUtils.copyFile(mImageInputPath, mImageOutputPath);
            return false;
        }
    }
